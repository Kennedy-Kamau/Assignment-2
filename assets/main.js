...
button10.addEventListener('click', () =>{
   ...
   indicator1.textContent =(parseInt(indicator1.textContent)+10).toString()
})
...
button15.addEventListener('click', () => {
 ...
 indicator2.textContent = (parseInt(indicator2.textContent)+15).toString()
})
...
button20.addEventListener('click', () =>{
  disp3.textContent = "add 20"
  indicator3.textContent = (parseInt(indicator3.textContent)+20).toString()
})